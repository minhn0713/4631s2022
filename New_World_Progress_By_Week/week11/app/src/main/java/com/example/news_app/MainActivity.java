    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MainActivity.this, chat_Welcome_Screen_1_MainActivity.class);
...
//         Intent intent = new Intent(this, chat_Welcome_Screen_1_MainActivity.class);
//         startActivity(intent);
//     }
